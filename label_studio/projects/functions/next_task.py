...
def get_task_from_qs_with_sampling(not_solved_tasks, user, project, queue_info):
    if project.sampling == project.SEQUENCE:
    ...
    with conditional_atomic():
        ...
        if flag_set('fflag_fix_back_lsdv_4523_show_overlap_first_order_27022023_short'):
            ...
            if not next_task and project.show_overlap_first:
                ...
                queue_info += 'Show overlap first'
                next_task, queue_info = get_task_from_qs_with_sampling(tasks_with_overlap, user, project, queue_info)
        ...
        if not next_task:
            if dm_queue:
                ...
                next_task, queue_info = get_task_from_qs_with_sampling(not_solved_tasks, user, project, queue_info)
